...
type InitialAnimationState = boolean | TargetAndTransition | VariantLabels;
type ExitAnimationState = TargetAndTransition | VariantLabels;
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props, ref) => {
  ...
  return (
    <motion.span className={cn('inline-flex flex-wrap', mainClassName)} {...rest} layout transition={transition}>
